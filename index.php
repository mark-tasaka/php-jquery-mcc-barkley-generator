...
<html>
<head>
<title>Launch Page: Barkley Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
			<form action="" id ="barkleyForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Barkley, Level 1</option>
				<option value="02">Barkley, Level 2</option>
				<option value="03">Barkley, Level 3</option>
				<option value="04">Barkley, Level 4</option>
				<option value="05">Barkley, Level 5</option>
				<option value="06">Barkley, Level 6</option>
				<option value="07">Barkley, Level 7</option>
				<option value="08">Barkley, Level 8</option>
				<option value="09">Barkley, Level 9</option>
				<option value="10">Barkley, Level 10</option>
			  </select>
        ...
        {
            $("#barkleyForm").attr('action', "barkley/barkley"+ $("#level").val() +  ".php");
        });
