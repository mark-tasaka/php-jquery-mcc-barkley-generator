...
<html>
<head>
<title>Iconic NPC Barkley Character Generator</title>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="css/mcc_barkley.css">
	<link rel="stylesheet" type="text/css" href="css/mcc_barkley_post.css">
...
<!-- JQuery -->
  ...
  <script>
	...
	/*
	 Character() - Barkley Character Constructor
	*/
	function Character() {
	
    let strength = <?php echo $totalArtifactStrength ?> + rollDice(6, 4, 1, 0);
    let agility = rollDice(6, 4, 1, 2);
    let stamina = rollDice(6, 4, 1, 7);
    ...
    let plantient = getBarkley();
		...
		let plantientCharacter = {
			...
			"speed": 25 + addLuckToSpeed(birthAugur, getLuckModifier(luck)) + "'",
			"modifiedSpeed": 25 - <?php echo $speedReduction ?> + addLuckToSpeed(birthAugur, getLuckModifier(luck)) + "'",
    ...
    /*getBarkley() return the statistics for the Manimal per level*/  
    function getBarkley() {
	let plantient = [
	...
	return plantient[8];  
       ...
       let imgData = "images/barkley_character_sheet.png";
